(function() { // protect the lemmings!
	...
	const textInsideFirstPageHeaderItem = $('#page-header li').eq(0).text();
	console.log(textInsideFirstPageHeaderItem)
	console.log($('#page-header li:eq(0)').text())
	console.log($('#page-header li:first').text())
	console.log($('#page-header li').first().text())
	...
	const oddChildrenOfCards = $('.card li:odd');
